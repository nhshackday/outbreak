# Django settings for outbreak project.
import commands
import os
import sys
...
ROOT_URLCONF = 'outbreak.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'outbreak.wsgi.application'
...
COVERAGE_EXCLUDE_MODULES = ('outbreak.migrations', 'outbreak.tests',
                            'outbreak.local_settings',
...
#GLOSSOLALIA_NAME = 'outbreak'

# OPAL required Django settings you should edit

CONTACT_EMAIL = []
DEFAULT_FROM_EMAIL = 'hello@example.com'
DEFAULT_DOMAIN = 'http://outbreak.com/'
